...
<body>
    ...
    ?>
        ...
        <h3  style="text-align: center;color:blue"><b>Transfer Money to</b></h3>
    </div>
    <div class="container-fluid">
        ...
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <div class="text-center">
                <button class="btn mt-3 waves-effect waves-light" name="submit" type="submit" id="myBtn">Transfer NOW</button>
            </div>
            <br>
        </form>
    </div>
...
if (isset($_POST['submit'])) {
    ...
    // constraint to check zero values
        ...
        $sql = "UPDATE customers set balance=$newbalance where c_id=$from";
        mysqli_query($conn, $sql);

        // adding amount to reciever's account
        $newbalance = $sql2['balance'] + $amount;
        $sql = "UPDATE customers set balance=$newbalance where c_id=$to";
        mysqli_query($conn, $sql);
